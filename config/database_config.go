...
type DatabaseConfig struct {
	...
	AuthorDbname   string `name:"AUTHOR_DB_DATABASE"`
	BookDbname     string `name:"BOOK_DB_DATABASE"`
	CategoryDbname string `name:"CATEGORY_DB_DATABASE"`
...
func DatabaseConfigConfig() *DatabaseConfig {
	return &DatabaseConfig{
		...
		AuthorDbname:   viper.GetString("AUTHOR_DB_DATABASE"),
		CategoryDbname: viper.GetString("CATEGORY_DB_DATABASE"),
